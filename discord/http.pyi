...
class HTTPClient:
    ...
    def send_message(self, channel_id: int, content: str, *, tts: bool = ..., embed: Optional[Dict[str, Any]] = ...,
                     nonce: Optional[int] = ...) -> Coroutine[Any, Any, _MessageDict]: ...
    ...
    def suppress_message_embeds(self, channel_id: int, message_id: int, *,
                                suppress: bool = ...) -> Coroutine[Any, Any, Any]: ...
    ...
    def follow_webhook(self, channel_id: int, webhook_channel_id: int) -> Coroutine[Any, Any, _WebhookDict]: ...
    ...
    def get_members(self, guild_id: int, limit: int,
                    after: Optional[int] = ...) -> Coroutine[Any, Any, List[_GuildMemberDict]]: ...
