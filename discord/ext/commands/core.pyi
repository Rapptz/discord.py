...
def has_role(name: str) -> Callable[[_F], _F]: ...

def has_any_role(*names: str) -> Callable[[_F], _F]: ...

def has_permissions(**perms: bool) -> Callable[[_F], _F]: ...

def bot_has_role(*names: str) -> Callable[[_F], _F]: ...

def bot_has_any_role(*names: str) -> Callable[[_F], _F]: ...
