...
class AsyncWebhookAdapter(WebhookAdapter):
    ...
    async def request(self, verb: str, url: str, payload: Optional[Dict[str, Any]] = ...,
                      multipart: Optional[Dict[str, Any]] = ..., *, files: Optional[Iterable[File]] = ...,
                      reason: Optional[str] = ...) -> Any: ...
...
class Webhook(Hashable):
    ...
    def edit(self, *, reason: Optional[str] = ..., **kwargs: Any) -> Union[_WebhookDict, Coroutine[Any, Any, _WebhookDict]]: ...
    @overload
