...
class DiscordWebSocket(websockets.client.WebSocketClientProtocol):  # type: ignore
    ...
    async def send(self, data: Union[_Data, Iterable[_Data], AsyncIterable[_Data]]) -> None: ...
    ...
    async def request_chunks(self, guild_id: int, query: str, limit: int, *, nonce: Optional[str]) -> None: ...
