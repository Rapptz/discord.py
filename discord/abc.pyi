...
class GuildChannel:
    ...
    @abc.abstractmethod
    def _update(self, guild: Guild, data: Any) -> None: ...

    async def _move(self, position: int, parent_id: Optional[int] = ..., lock_permissions: bool = ..., *, reason: Optional[str] = ...) -> None: ...

    async def _edit(self, options: Any, reason: Optional[str]) -> None: ...

    def _fill_overwrites(self, data: Any) -> None: ...
    ...
    async def set_permissions(self, target: Union['Member', Role], *,
                              ...
                              reason: Optional[str] = None, **permissions: Optional[bool]) -> None: ...
