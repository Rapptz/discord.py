...
class Embed:
    ...
    def set_image(self, *, url: Union[str, _EmptyEmbed]) -> _E: ...
    @property
    def thumbnail(self) -> _EmbedImageData: ...
    def set_thumbnail(self, *, url: Union[str, _EmptyEmbed]) -> _E: ...
    @property
    ...
    def insert_field_at(self, index: int, *, name: str, value: str, inline: bool = ...) -> _E: ...
