...
4. Go to the "OAuth2" section and click on the URL generator tab.
...
6. Scroll down to the "Bot Permissions" and tick the permissions required for your bot to function.
