...
extlinks = {"issue": ("https://github.com/Rapptz/discord.py/issues/%s", "GH-")}
...
latex_documents = [
    ("index", "discord.py.tex", u"discord.py Documentation", u"Rapptz", "manual")
]
...
man_pages = [("index", "discord.py", u"discord.py Documentation", [u"Rapptz"], 1)]
